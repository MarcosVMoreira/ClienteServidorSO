    ...
    public void run() {
        ...
        while (keepListening) {
            ...
            if (tokenizer.countTokens() == 3) {
                ...
                String pontosDesenhar = tokenizer.nextToken();
                String pontosApagar = tokenizer.nextToken();

                String concatena = pontosDesenhar + MESSAGE_SEPARATOR + pontosApagar;

                // send message to MessageListener
                messageListener.messageReceived(
                        command, // user name
                        concatena); // message body
            } // end if
        } // end while
