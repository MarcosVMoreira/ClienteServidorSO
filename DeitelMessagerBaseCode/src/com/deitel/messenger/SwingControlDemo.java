...
public class SwingControlDemo extends javax.swing.JFrame implements CommandListener {
    ...
    private CopyOnWriteArrayList ListaDePontosRecebidasDoServidorEQueDeveSerEnviadaAoCanvas = null;
    private CopyOnWriteArrayList ListaDePontosApagarRecebidasDoServidorEQueDeveSerEnviadaAoCanvas;
    private List<Point> CloneDaMinhaListaPontoApagarEnviadaDoCanvas = null;
    private List<Point> CloneDaMinhaListaPontoDesenhoEnviadaDoCanvas;
    ...
    public SwingControlDemo(MessageManager manager) {
        ...
        CloneDaMinhaListaPontoDesenhoEnviadaDoCanvas = new ArrayList<>();
        CloneDaMinhaListaPontoApagarEnviadaDoCanvas = new ArrayList<>();
        ListaDePontosRecebidasDoServidorEQueDeveSerEnviadaAoCanvas = new CopyOnWriteArrayList<>();
        ListaDePontosApagarRecebidasDoServidorEQueDeveSerEnviadaAoCanvas = new CopyOnWriteArrayList<>();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        controlPanel.add(new MyCanvas(this),BorderLayout.CENTER);
    ...
    private synchronized void sendMessage() {
        ...
        CloneDaMinhaListaPontoDesenhoEnviadaDoCanvas.toArray(temp);

        for (int i = 0; i < CloneDaMinhaListaPontoDesenhoEnviadaDoCanvas.size(); i++) {
        ...
        if (! CloneDaMinhaListaPontoDesenhoEnviadaDoCanvas.isEmpty()) {
        ...
        /* processa lista de pontos a apagar */
        Point tempApagar[] = new Point[100000];
        CloneDaMinhaListaPontoApagarEnviadaDoCanvas.toArray(tempApagar);

        for (int i = 0; i < CloneDaMinhaListaPontoApagarEnviadaDoCanvas.size(); i++) {

            message += tempApagar[i].x + CanvasConstants.POINT_SEPARATOR + tempApagar[i].y + CanvasConstants.POINT_SEPARATOR;
        }
        
          //se a lista de pontos a apagar não estiver vazia 
        if (! CloneDaMinhaListaPontoApagarEnviadaDoCanvas.isEmpty()) {
            message = message.substring(0, message.length() - 1);
        } else {
            //insere o ponto -1,-1 para indicar que não tem informação para desenhar na tela.
            message += "-1"+CanvasConstants.POINT_SEPARATOR + "-1";
        ...
        //mensagem pronta - chama o método sendMessage para enviar ao servidor
        ...
        CloneDaMinhaListaPontoDesenhoEnviadaDoCanvas.clear();
        CloneDaMinhaListaPontoApagarEnviadaDoCanvas.clear();
    ...
    public List<Point> getArrayPoint() {
        return ListaDePontosRecebidasDoServidorEQueDeveSerEnviadaAoCanvas;
    }
    ...
    public void setArrayPoint(List<Point> list) {
        ...
        temp.forEach((p) -> {
            CloneDaMinhaListaPontoDesenhoEnviadaDoCanvas.add(p);
        });

        System.out.println("CloneDaMinhaListaPontoDesenhoEnviadaDoCanvas: " + CloneDaMinhaListaPontoDesenhoEnviadaDoCanvas.size());

    }

    @Override
    public void setClearArrayPoint() {
        ListaDePontosRecebidasDoServidorEQueDeveSerEnviadaAoCanvas.clear();
    }

    @Override
    public List<Point> getArrayPointApagar() {
        return ListaDePontosApagarRecebidasDoServidorEQueDeveSerEnviadaAoCanvas;
    }

    @Override
    public void setClearArrayPointApagar() {
        ListaDePontosApagarRecebidasDoServidorEQueDeveSerEnviadaAoCanvas.clear();
    }
    ...
    public void setArrayPointApagar(List<Point> list) {
        ...
        temp.forEach((p) -> {
            CloneDaMinhaListaPontoApagarEnviadaDoCanvas.add(p);
        });

        System.out.println("CloneDaMinhaListaPontoApagarEnviadaDoCanvas size: " + CloneDaMinhaListaPontoApagarEnviadaDoCanvas.size());
    }
    ...
    private class MessageDisplayer {
        ...
        private synchronized void displayMessage(String from, String body) {
            ...
            Future<Boolean> future = (Future<Boolean>) executor.submit(() -> {
                ...
                //ListaDePontosRecebidasDoServidorEQueDeveSerEnviadaAoCanvas.clear();
                //System.out.println("Array clear: " + ListaDePontosRecebidasDoServidorEQueDeveSerEnviadaAoCanvas.size());
                ...
                for (i = 0; i < pointsDesenhar.length; i += 2) {
                    ...
                    ListaDePontosRecebidasDoServidorEQueDeveSerEnviadaAoCanvas.add(new Point(Integer.valueOf(pointsDesenhar[i]), Integer.valueOf(pointsDesenhar[i + 1])));
                }

                // processa os dados de apagar
                String[] pointsApagar = splits[1].split(CanvasConstants.POINT_SEPARATOR);
                ...
                for (i = 0; i < pointsApagar.length; i += 2) {
                    ...
                    ListaDePontosApagarRecebidasDoServidorEQueDeveSerEnviadaAoCanvas.add(new Point(Integer.valueOf(pointsApagar[i]), Integer.valueOf(pointsApagar[i + 1])));
                }
            ...
            try {
                ...
                System.out.println("Pontos recebidos para desenho: " + ListaDePontosRecebidasDoServidorEQueDeveSerEnviadaAoCanvas.size());
                System.out.println("Pontos recebidos para apagar: " + ListaDePontosApagarRecebidasDoServidorEQueDeveSerEnviadaAoCanvas.size());
